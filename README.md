...
* 在 Session 2 和 Session 3的标注中，Bot主动提及历史信息的方式包含2种：bot在**Session中间**主动提及 和 bot在**Session首句**主动提及两种方式。标注时**主要标注bot在聊天中间主动提及行为(占绝大多数)**；同时如果bot在session2、3首句主动提及记忆内容时，则需要过渡自然，不能太突兀的感觉。
