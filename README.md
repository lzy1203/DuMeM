...
* 在 Session 2 和 Session 3 的标注中，Bot主动提及历史信息的方式包含2种：
   * bot在<font color=red>Session中间主动提及<font>(user首句开始，bot在聊天中主动提及) 和 II: bot在**Session首句**主动提及(bot首句开始就主动提及记忆)两种方式。
